...
class UserManager(AbstractBaseUser, PermissionsMixin):
    ...
    town = models.CharField(max_length=255, default=False, null=True)
    title = models.CharField(max_length=10, default=False, null=True)
    gender = models.CharField(max_length=10, default=False, null=True)
    address = models.CharField(max_length=200, default=False, null=True)
    password = models.CharField(max_length=500, default=False, null=True)
    religion = models.CharField(max_length=255, default=False, null=True)
    area_code = models.CharField(max_length=10, default=False, null=True)
    last_name = models.CharField(max_length=255, default=False, null=True)
    supervisor_id = models.PositiveSmallIntegerField(blank=True, null=True)
    first_name = models.CharField(max_length=255, default=False, null=True)
    middle_name = models.CharField(max_length=255, default=False, null=True)
    phone_number = models.CharField(max_length=255, default=False, null=True)        
    marital_status = models.CharField(max_length=255, default=False, null=True)
    id_document_type = models.CharField(max_length=255, default=False, null=True)
    id_document_number = models.CharField(max_length=255, default=False, null=True)
    email = models.EmailField(max_length=255, default=False, unique=True, null=True)
    residency = models.CharField(max_length=255, choices=COUNTRY_CODE_CHOICES, default=False, null=True)
    nationality = models.CharField(max_length=255, choices=COUNTRY_CODE_CHOICES, default=False, null=True)
