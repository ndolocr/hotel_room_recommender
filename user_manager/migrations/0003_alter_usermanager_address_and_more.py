...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('user_manager', '0002_alter_usermanager_dob'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='usermanager',
            name='email',
            field=models.EmailField(default=False, max_length=255, null=True, unique=True),
        ),
        migrations.AlterField(
            model_name='usermanager',
            name='first_name',
